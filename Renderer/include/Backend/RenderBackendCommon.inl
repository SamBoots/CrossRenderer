...
namespace BB
{
	static inline const char* DescriptorTypeStr(const RENDER_DESCRIPTOR_TYPE a_Type)
	{
		...
		case RENDER_DESCRIPTOR_TYPE::READONLY_CONSTANT_DYNAMIC:	return "READONLY_CONSTANT_DYNAMIC";
		case RENDER_DESCRIPTOR_TYPE::READONLY_BUFFER_DYNAMIC:	return "READONLY_BUFFER_DYNAMIC";
		case RENDER_DESCRIPTOR_TYPE::READWRITE_DYNAMIC:			return "READWRITE_DYNAMIC";
