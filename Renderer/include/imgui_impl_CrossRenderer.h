...
IMGUI_IMPL_API void ImGui_ImplCross_RenderDrawData(const ImDrawData& a_DrawData, const BB::CommandListHandle a_CommandList, const BB::PipelineHandle a_Pipeline = BB_INVALID_HANDLE);
