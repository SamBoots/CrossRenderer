...
#pragma endregion
	...
	namespace VKConv
	{
		...
		inline VkDescriptorType DescriptorBufferType(const RENDER_DESCRIPTOR_TYPE a_Type)
		{
			switch (a_Type)
			{
			case BB::RENDER_DESCRIPTOR_TYPE::READONLY_CONSTANT:			return VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC;
			case BB::RENDER_DESCRIPTOR_TYPE::READONLY_BUFFER:			return VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC;
			...
			case BB::RENDER_DESCRIPTOR_TYPE::INPUT_ATTACHMENT:			return VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT;
