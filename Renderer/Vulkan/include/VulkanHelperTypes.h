...
#pragma endregion
	...
	namespace VKConv
	{
		...
		inline VkDescriptorType DescriptorBufferType(const DESCRIPTOR_BUFFER_TYPE a_Type)
		{
			...
			case BB::DESCRIPTOR_BUFFER_TYPE::READWRITE:					return VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC;
			case BB::DESCRIPTOR_BUFFER_TYPE::INPUT_ATTACHMENT:			return VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT;
			case BB::DESCRIPTOR_BUFFER_TYPE::COMBINED_IMAGE_SAMPLER:	return VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
			default:
