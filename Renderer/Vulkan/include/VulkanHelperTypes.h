...
namespace BB
{
	...
	namespace VKConv
	{
		...
		static inline VkBufferUsageFlags RenderBufferUsage(const RENDER_BUFFER_USAGE a_Usage)
		{
			...
			case RENDER_BUFFER_USAGE::UNIFORM:					return VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT;
			case RENDER_BUFFER_USAGE::STORAGE:					return VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT;
			case RENDER_BUFFER_USAGE::STAGING:					return VK_BUFFER_USAGE_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT;
			default:
		...
		static inline VkPipelineStageFlags2 PipelineStage(const RENDER_PIPELINE_STAGE a_Stage)
		{
			switch (a_Stage)
			{
			case RENDER_PIPELINE_STAGE::TOP_OF_PIPELINE:		return VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT;
			case RENDER_PIPELINE_STAGE::TRANSFER:				return VK_PIPELINE_STAGE_2_TRANSFER_BIT;
			case RENDER_PIPELINE_STAGE::VERTEX_INPUT:			return VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT;
			case RENDER_PIPELINE_STAGE::VERTEX_SHADER:			return VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT;
			case RENDER_PIPELINE_STAGE::EARLY_FRAG_TEST:		return VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT;
			case RENDER_PIPELINE_STAGE::FRAGMENT_SHADER:		return VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT;
			case RENDER_PIPELINE_STAGE::END_OF_PIPELINE:		return VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT;
			default:
		...
		static inline VkAccessFlags2 AccessMask(const RENDER_ACCESS_MASK a_Type)
		{
			switch (a_Type)
			{
			case RENDER_ACCESS_MASK::NONE:						return VK_ACCESS_2_NONE;
			case RENDER_ACCESS_MASK::TRANSFER_WRITE:			return VK_ACCESS_2_TRANSFER_WRITE_BIT;
			case RENDER_ACCESS_MASK::DEPTH_STENCIL_READ_WRITE:	return VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT | VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
			case RENDER_ACCESS_MASK::SHADER_READ:				return VK_ACCESS_2_SHADER_READ_BIT;
			default:
		...
		inline ExtensionResult TranslateExtensions(const Allocator a_TempAllocator, BB::Slice<RENDER_EXTENSIONS> a_Extensions)
		{
			...
			for (size_t i = 0; i < a_Extensions.size(); i++)
			{
				...
				case BB::RENDER_EXTENSIONS::STANDARD_VULKAN_DEVICE:
					...
					t_Result.extensions[t_Result.count++] = VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME;
					break;
